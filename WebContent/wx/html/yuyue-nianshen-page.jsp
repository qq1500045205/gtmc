	...
	<div class="content">
		<form action="" method='post' name='yuyue' class='m-form'>
			...
			<div class="m-form-item" id='carTypeGuidBox'>
				...
				<div class="m-input-box">
					<select name="carNumberPfx" id="carNumberPfx" style='width:30%;display:inline;'>
			...
			<Button type="button" class="btn_main" id="reserve">预约年审</Button> 
		</form>
	</div>
</div>
...
<script>
	...
	window.yuyue_post = function(){
		...
		req.postData("/yuyue/addYuyueNianShen", formdata, function(ret){
			if(ret.message=='codefailure'){
				alert('验证码出错');
			}else
			if( ret.message=='success'){
				Util.Browser.jump(urls[0].src, '16-1-a');
			}
		});
	};
	//点击事件
	...
	stat.report('16-1-a', "预约年审", gzhHash, openid, {});
    </script>
