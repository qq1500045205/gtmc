...
<div class="container-fluid" style="min-width:600px">
		<div class="row-fluid div_header">
			<label>标题</label><input type="text" name="title" id="title" style="display:inline;float:left" />
			<label>所属类别</label>
	...
	<script type="text/javascript">
		...
		console.log("textGuid:", textGuid);
		$.getJSON("${ctx}/mannual/getMannualtext",
			{textGuid: textGuid},
			function(res){
				data = res.result[0];
				console.log(res);
		...
		$("#save_page_content_btn").click(function(){
			...
			$.ajax({
				 type:"POST",
				 url:"${ctx}/mannual/editMannualtext",
				 data:{textGuid: data.textGuid, typeGuid:typeId,typeName:type,title:title,content:cnt},
