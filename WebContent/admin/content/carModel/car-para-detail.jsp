  ...
  <head>
   ...
   <body>	
    ...
    $(function() {
		...
		//alert(data.carNavigateGuid);
		$.ajax({
			 type:"POST",
			 url:"${ctx}/car/queryCarPara",
		...
		function setData(data){
			$("#name").val(data.carParaName);
			$("#value").val(data.carParaValue);
			$("#inputSortId").val(data.carParaSortid);
		}
	});
