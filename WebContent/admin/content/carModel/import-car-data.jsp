	...
	<div class="container-fluid">
		...
		<div class="span6">
				<div class="accordion">
					...
					<form action="${ctx}/car/importcardata" id="importcardata" name="importcardata"  method="post" enctype ="multipart/form-data">
						<div><label>请选择上传文件:</label><input type="file" name="inputfile" id="inputfile"/></div>
						<div><label></label><input type="submit" id="submit" value="上传"></div>
					</form>
					</div>
