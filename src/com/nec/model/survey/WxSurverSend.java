...
/**
 * WxSurverSend entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "wx_surver_send")
public class WxSurverSend implements java.io.Serializable {
	...
	/** full constructor */
	public WxSurverSend(String orderno, String openId, String companycode,
			String wxcompanyname, String customername, String customerphone,
			String vinno, String model, String platenumber, String repairdate,
			String buydate, String credate, String creuser, String updatetime,
			String updateuser) {
